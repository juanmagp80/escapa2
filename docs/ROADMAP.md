...
- [x] Explorar con resultados (filtros de presupuesto, transporte, horas útiles, destino y duración conectados al repositorio).
...
- [x] Perfil Android editable (ciudad, moneda, presupuesto, máximo en coche, transporte, intereses, exclusiones) con aeropuertos en solo lectura.
- [x] Detalle de oportunidad con historial de precios (anterior → actual) y botón para seguir la búsqueda.
